      ...
      <Disclosure v-slot="{ open }">
        ...
        <DisclosurePanel class="px-4 pb-2 pt-4 text-sm">
          <div class="flex flex-col gap-4">
            <div>
              Modifying advanced settings can significantly impact the performance and system
              stability. These options are intended for experienced users who understand these
              options.
            </div>
